...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/08/11 10:51:08 by grodrig2          #+#    #+#             */
/*   Updated: 2025/08/11 12:30:21 by grodrig2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_select_print(int flag, va_list args)
{
	if (flag == '0')
		...
		return (ft_putnbr_base(va_arg(args, unsigned int), 10, flag));
	else if (flag == '5')
		return (ft_putnbr_base(va_arg(args, unsigned int), 10, flag));
	else if (flag == '6' || flag == '7')
		return (ft_putnbr_base(va_arg(args, unsigned int), 16, flag));
	else
